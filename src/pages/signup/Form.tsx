...
export default function Form() {
  ...
  return (
    <div className=" w-full h-screen py-[50px]">
      <div className="w-full max-w-[800px] mx-auto ">
        <div className="bg-white border-slate-600 border-2 rounded-xl p-6 relative  mx-1 ">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              />
              <Input
                className=" border rounded-lg border-slate-700 focus:outline-none focus:border-transparent appearance-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none [&::-moz-appearance:textfield]"
